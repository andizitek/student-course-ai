...
`ollama pull gemma3:1b` oder `ollama pull llama3.2:1b` (klein, schnell, zum Testen - aber auch sehr eingeschränkt in der Promp- und Antwortgenauigkeit; auch mit JSON gibt es meist Probleme)
